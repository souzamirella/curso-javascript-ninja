...
*/
var pessoa = {nome:'Mirella', sobrenome:'Souza', sexo:'Feminino', idade:27, altura:1.68, peso:70, andando:false,caminhouQuantosMetros: Number(0)};
...
*/
pessoa.nomeCompleto //"Meu nome é Mirella Souza"
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura //"Minha altura é 1.68 m."
